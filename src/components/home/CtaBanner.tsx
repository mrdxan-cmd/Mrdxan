...
/** Sub-page call-to-action banner in the mockup's dark/gradient style. */
  ...
  return (
    <section className="container-x py-16 sm:py-20">
      <div className="surface-dark relative overflow-hidden rounded-3xl px-6 py-12 sm:px-12 sm:py-16">
        <div aria-hidden="true" className="splash-brand pointer-events-none absolute -right-10 -top-10 h-56 w-80 opacity-60" />
